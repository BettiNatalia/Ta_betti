...
<!--2.  untuk membuat link teks data User dan dashboard -->
    <div class="mt-0 mb-0 d-flex justify-content-between">
        <a class="nav-link" href="<?= base_url() ?>web/data_suhu/suhu">
        <span class="h6 font-weight-bold" style=" color: primary;"><i class="fas fa-file"></i> Data Suhu</span>
    </a>
...
<!-- 4. membuat Button tambah di sebelah kiri. untuk memindahkan button gunakan float:left atau float right -->
            <a href="<?= base_url('web/data_suhu/suhu/add') ?>" class="btn btn-info btn-sm mb-0" style="float: left;"><i class="fas fa-plus"></i>Tambah Data</a>
    </div>
...
<!--  6. membuat nama kolom atau atribut-->
                        <tr>
                            ...
                            <th class="text-center" style="color: black;">BJ Terhadap Suhu</th>
...
<!-- 10. data adalah objek dan datas adalah variabel bagian ini untuk menampilkan nilai dari data kolom-->
                            ...
                            <td><?php echo $i ?></td>
                            <td><?php echo $datas->suhu ?></td>
                            <td><?php echo $datas->BJ ?></td>
<!-- 11. membuat satu kolom pada kolom aksi dengan lebar kolom 100px -->
                            <td style="width: 100px;">
                            <a class=" btn-sm bg-gradient-primary" onclick="return confirm('Anda Yakin Ingin Edit')" href="<?= base_url('web/data_suhu/suhu/edit/' . $datas->id_suhu) ?>" class=""><i class="far fa-edit" style="color: #fcfcfd;"></i></a>
                            <a class="btn-sm bg-gradient-danger" onclick="return confirm('Anda Yakin Ingin Hapus')" href="<?= base_url('web/data_suhu/suhu/delete/' . $datas->id_suhu) ?>"><i class="fas fa-trash" style="color: #f1f2f4;"></i></a>
                        </td>
                </tr>
