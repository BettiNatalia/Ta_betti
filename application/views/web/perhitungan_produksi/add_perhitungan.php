<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-header">Form Tambah Data Pemasaran Kernel</div>
        <div class="card-body">
            <div class="row">
                <div class="col-sm-3">
                    <a href="<?= base_url('web/data_pemkernel/pemkernel/') ?>" class="btn btn-info btn-sm">Back</a>
                </div>
                <div class="col-sm-6">
                    <form action="<?= base_url('web/data_pemkernel/pemkernel/create/') ?>"
