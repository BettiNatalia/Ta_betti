<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4" tyle="color: black">
        <h1 class="h3 mb-0 font-weight-bold" style="color: black">Data Pemasaran Kernel</h1>
    </div>
    ...
    <div class="row">
        <div class="card-body">
            <div class="table-responsive">
                <a href="<?= base_url('web/data_pemkernel/pemkernel/add') ?>"
                    ...
                    <tbody>
                        <?php foreach ($data as $datas): ?>
                            <tr  style="font: size 3px; background-color: aliceblue; color: black">
                                ...
                                <td>
                                    <a href="<?= base_url('web/data_pemkernel/pemkernel/edit/' . $datas->id_pemasaran) ?>"
                                        class="btn btn-info btn-sm">Edit</a>
                                    <a href="<?= base_url('web/data_pemkernel/pemkernel/delete/' . $datas->id_pemasaran) ?>"
