...
<!-- 1. Page Heading -->
    <div class="card shadow">
        <div class="card-header">Edit Data Tanki CPO</div>
        <div class="card-body">
            <div class="row">
...
<!-- 3. untuk membuat panjang form yaitu col-sm-6 -->
                <div class="col-sm-6">
                    <form action="<?= base_url('web/data_tankicpo/tankicpo/update/') ?>"
...
<!-- untuk edit selalu menambahkan input 1 lagi agar sistem mengerti yang menjadi keyword data dan id_suplier adalah parameter di button edit view -->
                            <input type="hidden" class="form-control" name="id_tcpo" value="<?= $data->id_tcpo ?>">
                        </div>
                        <div class="form-group">
