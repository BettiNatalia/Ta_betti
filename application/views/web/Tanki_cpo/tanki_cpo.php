...
<!--2.  untuk membuat link teks data User dan dashboard -->
    <div class="mt-0 mb-0 d-flex justify-content-between">
        <a class="nav-link" href="<?= base_url() ?>web/data_tankicpo/tankicpo">
        <span class="h6 font-weight-bold" style=" color: primary;"><i class="fas fa-file"></i> Data Tanki CPO</span>
    </a>
...
<!-- 4. membuat Button tambah di sebelah kiri. untuk memindahkan button gunakan float:left atau float right -->
            <a href="<?= base_url('web/data_tankicpo/tankicpo/add') ?>" class="btn btn-info btn-sm mb-0" style="float: left;"><i class="fas fa-plus"></i>Tambah Data</a>
    </div>
...
<!-- 11. membuat satu kolom pada kolom aksi dengan lebar kolom 100px -->
                            ...
                            <a class=" btn-sm bg-gradient-primary" onclick="return confirm('Anda Yakin Ingin Edit')" href="<?= base_url('web/data_tankicpo/tankicpo/edit/' . $datas->id_tcpo) ?>" class=""><i class="far fa-edit" style="color: #fcfcfd;"></i></a>
                            <a class="btn-sm bg-gradient-danger" onclick="return confirm('Anda Yakin Ingin Hapus')" href="<?= base_url('web/data_tankicpo/tankicpo/delete/' . $datas->id_tcpo) ?>"><i class="fas fa-trash" style="color: #f1f2f4;"></i></a>
                        </td>
                </tr>
