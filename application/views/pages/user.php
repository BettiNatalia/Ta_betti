...
<!--2.  untuk membuat link teks data User dan dashboard -->
    <div class="mt-0 mb-0 d-flex justify-content-between">
        ...
        <span class="h6 font-weight-bold" style=" color: primary;"><i class="fas fa-file"></i> Data User</span>
    </a>
...
<!-- 4. membuat Button tambah di sebelah kiri. untuk memindahkan button gunakan float:left atau float right -->
            <a href="<?= base_url('admin/user/add') ?>" class="btn btn-info btn-sm mb-0" style="float: left;"><i class="fas fa-plus"></i>Tambah Data</a>
    </div>
...
<!--  6. membuat nama kolom atau atribut-->
                        <tr>
                            ...
                            <th class="text-center" style="color: black;">Level</th>
                            <th class="text-center" style="color: black;">Aktif</th>
...
<!-- 10. data adalah objek dan datas adalah variabel bagian ini untuk menampilkan nilai dari data kolom-->
                            ...
                            <td style="width : 70px;"><?php echo $datas->aktif ?></td>
<!-- 11. membuat satu kolom pada kolom aksi dengan lebar kolom 100px -->
                            <td style="width: 100px;">
                            <a href="<?= base_url('admin/user/detail/' . $datas->id_user) ?>" class="btn-sm bg-gradient-info"><i class="fas fa-search-plus" style="color: #ffffff;"></i></a>
                            <a class=" btn-sm bg-gradient-primary" onclick="return confirm('Anda Yakin Ingin Edit')" href="<?= base_url('admin/user/edit/' . $datas->email) ?>" class=""><i class="far fa-edit" style="color: #fcfcfd;"></i></a>
                            <a class="btn-sm bg-gradient-danger" onclick="return confirm('Anda Yakin Ingin Hapus')" href="<?= base_url('admin/user/delete/' . $datas->email) ?>"><i class="fas fa-trash" style="color: #f1f2f4;"></i></a>
                        </td>
                </tr>
